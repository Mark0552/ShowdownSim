        ...
        <g>
            ...
            {!state.isOver && isMyTurn && state.phase === 'sp_roll' && (
                <g className="roll-button" onClick={() => onAction({ type: 'ROLL_STARTERS' })} cursor="pointer">
                    <rect x="550" y="840" width="300" height="50" rx="10" fill="#d4a018" stroke="#f0c840" strokeWidth="2"/>
                    <text x="700" y="872" textAnchor="middle" fontSize="22" fill="#002" fontWeight="900" fontFamily="Impact,sans-serif" letterSpacing="3">ROLL FOR PITCHERS</text>
                </g>
            )}
            {!state.isOver && !isMyTurn && state.phase === 'sp_roll' && (
                <g>
                    <rect x="550" y="850" width="300" height="40" rx="6" fill="rgba(0,0,0,0.6)"/>
                    <text x="700" y="877" textAnchor="middle" fontSize="14" fill="#888" fontStyle="italic" fontFamily="Arial">Waiting for home team to roll...</text>
                </g>
            )}
            ...
            {!state.isOver && isMyTurn && state.phase === 'defense_sub' && (() => {
                ...
                <g>
                    {canChangePitcher && (
                        <g className="roll-button" onClick={() => onShowSubPanel()} cursor="pointer">
                            <rect x="420" y="840" width="160" height="34" rx="6" fill="#d4a018" stroke="#f0c840" strokeWidth="1.5"/>
                            <text x="500" y="862" textAnchor="middle" fontSize="12" fill="#002" fontWeight="900" fontFamily="Impact">CHANGE PITCHER</text>
                        </g>
                    )}
                    ...
                    {!state.icon20UsedThisInning && fieldingTeam.pitcher.icons?.includes('20') && (
                        <g className="roll-button" onClick={() => onAction({ type: 'USE_ICON', cardId: fieldingTeam.pitcher.cardId, icon: '20' })} cursor="pointer">
                            <rect x="590" y="840" width="130" height="34" rx="6" fill="#60a5fa" stroke="#93c5fd" strokeWidth="1.5"/>
                            <text x="655" y="862" textAnchor="middle" fontSize="12" fill="#002" fontWeight="900" fontFamily="Impact">USE 20 (+3)</text>
                        </g>
                    )}
                    ...
                    {state.inning > 6 && !state.rpActiveInning && fieldingTeam.pitcher.icons?.includes('RP') && (
                        <g className="roll-button" onClick={() => onAction({ type: 'USE_ICON', cardId: fieldingTeam.pitcher.cardId, icon: 'RP' })} cursor="pointer">
                            <rect x="730" y="840" width="130" height="34" rx="6" fill="#60a5fa" stroke="#93c5fd" strokeWidth="1.5"/>
                            <text x="795" y="862" textAnchor="middle" fontSize="12" fill="#002" fontWeight="900" fontFamily="Impact">USE RP (+3)</text>
                        </g>
                    )}
                    <g className="roll-button" onClick={() => onAction({ type: 'SKIP_SUB' })} cursor="pointer">
                        <rect x="870" y="840" width="80" height="34" rx="6" fill="#334155" stroke="#64748b" strokeWidth="1.5"/>
                        <text x="910" y="862" textAnchor="middle" fontSize="12" fill="#ccc" fontWeight="900" fontFamily="Impact">SKIP</text>
                    </g>
                </g>
                );
            })()}
            ...
            {!state.isOver && isMyTurn && state.phase === 'ibb_decision' && (
                <g>
                    <g className="roll-button" onClick={() => onAction({ type: 'INTENTIONAL_WALK' })} cursor="pointer">
                        <rect x="500" y="840" width="180" height="34" rx="6" fill="#f59e0b" stroke="#fbbf24" strokeWidth="1.5"/>
                        <text x="590" y="862" textAnchor="middle" fontSize="12" fill="#002" fontWeight="900" fontFamily="Impact">INTENTIONAL WALK</text>
                    </g>
                    <g className="roll-button" onClick={() => onAction({ type: 'SKIP_IBB' })} cursor="pointer">
                        <rect x="700" y="840" width="80" height="34" rx="6" fill="#334155" stroke="#64748b" strokeWidth="1.5"/>
                        <text x="740" y="862" textAnchor="middle" fontSize="12" fill="#ccc" fontWeight="900" fontFamily="Impact">PITCH</text>
                    </g>
                </g>
            )}
            ...
            {!state.isOver && isMyTurn && state.phase === 'bunt_decision' && (
                <g>
                    <g className="roll-button" onClick={() => onAction({ type: 'SAC_BUNT' })} cursor="pointer">
                        <rect x="500" y="840" width="150" height="34" rx="6" fill="#8b5cf6" stroke="#a78bfa" strokeWidth="1.5"/>
                        <text x="575" y="862" textAnchor="middle" fontSize="12" fill="white" fontWeight="900" fontFamily="Impact">SAC BUNT</text>
                    </g>
                    <g className="roll-button" onClick={() => onAction({ type: 'SKIP_BUNT' })} cursor="pointer">
                        <rect x="670" y="840" width="80" height="34" rx="6" fill="#334155" stroke="#64748b" strokeWidth="1.5"/>
                        <text x="710" y="862" textAnchor="middle" fontSize="12" fill="#ccc" fontWeight="900" fontFamily="Impact">SKIP</text>
                    </g>
                </g>
            )}
            ...
            {!state.isOver && isMyTurn && state.phase === 'pitch' && (
                <g className="roll-button" onClick={() => onAction({ type: 'ROLL_PITCH' })} cursor="pointer">
                    <rect x="600" y="850" width="200" height="45" rx="8" fill="#e94560" stroke="#ff6b8a" strokeWidth="2"/>
                    <text x="700" y="880" textAnchor="middle" fontSize="20" fill="white" fontWeight="900" fontFamily="Impact,sans-serif" letterSpacing="2">ROLL PITCH</text>
                </g>
            )}
            ...
            {!state.isOver && isMyTurn && state.phase === 'swing' && (
                <g className="roll-button" onClick={() => onAction({ type: 'ROLL_SWING' })} cursor="pointer">
                    <rect x="600" y="850" width="200" height="45" rx="8" fill="#4ade80" stroke="#6bff9a" strokeWidth="2"/>
                    <text x="700" y="880" textAnchor="middle" fontSize="20" fill="#002" fontWeight="900" fontFamily="Impact,sans-serif" letterSpacing="2">ROLL SWING</text>
                </g>
            )}
            ...
            {!state.isOver && isMyTurn && state.phase === 'result_icons' && state.iconPrompt && (
                <g>
                    <rect x="480" y="824" width="440" height="40" rx="6" fill="rgba(0,0,0,0.8)"/>
                    <text x="700" y="836" textAnchor="middle" fontSize="13" fill="#d4a018" fontWeight="bold" fontFamily="Arial">
                    ...
                    {state.iconPrompt.availableIcons.map((ic, i) => (
                        <g key={`icon-${i}`} className="roll-button" onClick={() => onAction({ type: 'USE_ICON', cardId: ic.cardId, icon: ic.icon })} cursor="pointer">
                            <rect x={500 + i * 150} y="840" width="140" height="38" rx="6" fill="#d4a018" stroke="#f0c840" strokeWidth="1.5"/>
                            <text x={570 + i * 150} y="864" textAnchor="middle" fontSize="12" fill="#002" fontWeight="bold" fontFamily="Arial">{ic.description.split(':')[0]}</text>
                        </g>
                    ))}
                    <g className="roll-button" onClick={() => onAction({ type: 'SKIP_ICONS' })} cursor="pointer">
                        <rect x={500 + state.iconPrompt.availableIcons.length * 150} y="840" width="100" height="38" rx="6" fill="#334155" stroke="#64748b" strokeWidth="1.5"/>
                        <text x={550 + state.iconPrompt.availableIcons.length * 150} y="864" textAnchor="middle" fontSize="12" fill="#ccc" fontWeight="bold" fontFamily="Arial">DECLINE</text>
                    </g>
                </g>
            )}
            ...
            {!state.isOver && isMyTurn && state.phase === 'extra_base_offer' && state.extraBaseEligible && (
                <g>
                    <rect x="380" y="824" width="640" height="40" rx="6" fill="rgba(0,0,0,0.85)"/>
                    <text x="700" y="838" textAnchor="middle" fontSize="13" fill="#4ade80" fontWeight="bold" fontFamily="Arial">
                    ...
                    {state.extraBaseEligible.map((runner, i) => (
                        <g key={`ebo-${i}`} className="roll-button" onClick={() => onAction({ type: 'SEND_RUNNERS', runnerIds: [runner.runnerId] })} cursor="pointer">
                            <rect x={420 + i * 190} y="850" width="180" height="38" rx="6" fill="#4ade80" stroke="#6bff9a" strokeWidth="1.5"/>
                            <text x={510 + i * 190} y="860" textAnchor="middle" fontSize="11" fill="#002" fontWeight="bold" fontFamily="Arial">SEND: {runner.runnerName}</text>
                            <text x={510 + i * 190} y="862" textAnchor="middle" fontSize="9" fill="rgba(0,0,0,0.6)" fontFamily="monospace">{runner.fromBase}{'\u2192'}{runner.toBase} Spd:{runner.runnerSpeed}</text>
                        </g>
                    ))}
                    {state.extraBaseEligible.length > 1 && (
                        <g className="roll-button" onClick={() => onAction({ type: 'SEND_RUNNERS', runnerIds: state.extraBaseEligible!.map(r => r.runnerId) })} cursor="pointer">
                            <rect x={420 + state.extraBaseEligible.length * 190} y="850" width="120" height="38" rx="6" fill="#22c55e" stroke="#4ade80" strokeWidth="1.5"/>
                            <text x={480 + state.extraBaseEligible.length * 190} y="874" textAnchor="middle" fontSize="11" fill="#002" fontWeight="bold" fontFamily="Arial">SEND ALL</text>
                        </g>
                    )}
                    <g className="roll-button" onClick={() => onAction({ type: 'HOLD_RUNNERS' })} cursor="pointer">
                        <rect x={420 + (state.extraBaseEligible.length + (state.extraBaseEligible.length > 1 ? 1 : 0)) * 190} y="850" width="100" height="38" rx="6" fill="#334155" stroke="#64748b" strokeWidth="1.5"/>
                        <text x={470 + (state.extraBaseEligible.length + (state.extraBaseEligible.length > 1 ? 1 : 0)) * 190} y="874" textAnchor="middle" fontSize="11" fill="#ccc" fontWeight="bold" fontFamily="Arial">HOLD</text>
                    </g>
                </g>
            )}
            ...
            {!state.isOver && isMyTurn && state.phase === 'gb_decision' && state.gbOptions && (
                <g>
                    <rect x="350" y="824" width="700" height="40" rx="6" fill="rgba(0,0,0,0.85)"/>
                    <text x="700" y="836" textAnchor="middle" fontSize="13" fill="#e94560" fontWeight="bold" fontFamily="Arial">
                        ...
                        return buttons.map((btn, i) => (
                            <g key={`gb-${i}`}>
                                <g className="roll-button" onClick={() => onAction({ type: 'GB_DECISION', choice: btn.choice as any })} cursor="pointer">
                                    <rect x={startX + i * (bw + gap)} y="840" width={bw} height="38" rx="6" fill={btn.color} stroke="rgba(255,255,255,0.3)" strokeWidth="1"/>
                                    <text x={startX + i * (bw + gap) + bw/2} y="856" textAnchor="middle" fontSize="10" fill="white" fontWeight="bold" fontFamily="Arial">{btn.label}</text>
                                    <text x={startX + i * (bw + gap) + bw/2} y="850" textAnchor="middle" fontSize="8" fill="rgba(255,255,255,0.6)" fontFamily="Arial">{btn.sub}</text>
                                </g>
                                {btn.choice !== 'force_home' && gPlayers.map((gp, gi) => (
                                    <g key={`gb-g-${i}-${gi}`} className="roll-button" onClick={() => onAction({ type: 'GB_DECISION', choice: btn.choice as any, goldGloveCardId: gp.cardId })} cursor="pointer">
                                        <rect x={startX + i * (bw + gap)} y={882 + gi * 18} width={bw} height="16" rx="3" fill="#d4a018" stroke="#f0c840" strokeWidth="1"/>
                                        <text x={startX + i * (bw + gap) + bw/2} y={894 + gi * 18} textAnchor="middle" fontSize="8" fill="#002" fontWeight="bold" fontFamily="Arial">+ G: {gp.name} ({gp.position})</text>
                                    </g>
                                ))}
                            </g>
                        ));
            ...
            {!state.isOver && isMyTurn && state.phase === 'steal_resolve' && state.pendingSteal && (
                <g>
                    <rect x="380" y="824" width="640" height="40" rx="6" fill="rgba(0,0,0,0.85)"/>
                    <text x="700" y="838" textAnchor="middle" fontSize="13" fill="#e94560" fontWeight="bold" fontFamily="Arial">
                    ...
                    {(state.pendingSteal.catcherGPlayers || []).map((gp: any, i: number) => (
                        <g key={`sg-${i}`} className="roll-button" onClick={() => onAction({ type: 'STEAL_G_DECISION', goldGloveCardId: gp.cardId })} cursor="pointer">
                            <rect x={480 + i * 160} y="850" width="150" height="38" rx="6" fill="#d4a018" stroke="#f0c840" strokeWidth="1.5"/>
                            <text x={555 + i * 160} y="874" textAnchor="middle" fontSize="11" fill="#002" fontWeight="bold" fontFamily="Arial">G: {gp.name} (+10)</text>
                        </g>
                    ))}
                    <g className="roll-button" onClick={() => onAction({ type: 'STEAL_G_DECISION' })} cursor="pointer">
                        <rect x={480 + (state.pendingSteal.catcherGPlayers || []).length * 160} y="850" width="120" height="38" rx="6" fill="#334155" stroke="#64748b" strokeWidth="1.5"/>
                        <text x={540 + (state.pendingSteal.catcherGPlayers || []).length * 160} y="874" textAnchor="middle" fontSize="12" fill="#ccc" fontWeight="bold" fontFamily="Arial">NO G</text>
                    </g>
                </g>
            )}
            ...
            {!state.isOver && isMyTurn && state.phase === 'extra_base' && state.extraBaseEligible && (
                <g>
                        ...
                        return state.extraBaseEligible!.map((runner, i) => (
                            <g key={`eb-${i}`}>
                                <g className="roll-button" onClick={() => onAction({ type: 'EXTRA_BASE_THROW', runnerId: runner.runnerId })} cursor="pointer">
                                    <rect x={420 + i * 200} y="840" width="180" height="34" rx="6" fill="#e94560" stroke="#ff6b8a" strokeWidth="1.5"/>
                                    <text x={510 + i * 200} y="856" textAnchor="middle" fontSize="11" fill="white" fontWeight="bold" fontFamily="Arial">THROW: {runner.runnerName}</text>
                                    <text x={510 + i * 200} y="869" textAnchor="middle" fontSize="9" fill="rgba(255,255,255,0.7)" fontFamily="monospace">{runner.fromBase}{'\u2192'}{runner.toBase} Tgt:{(runner as any).targetWithBonuses || runner.runnerSpeed}</text>
                                </g>
                                {gPlayers.map((gp: any, gi: number) => (
                                    <g key={`eb-g-${i}-${gi}`} className="roll-button" onClick={() => onAction({ type: 'EXTRA_BASE_THROW', runnerId: runner.runnerId, goldGloveCardId: gp.cardId })} cursor="pointer">
                                        <rect x={420 + i * 200} y={878 + gi * 18} width="180" height="16" rx="3" fill="#d4a018" stroke="#f0c840" strokeWidth="1"/>
                                        <text x={510 + i * 200} y={890 + gi * 18} textAnchor="middle" fontSize="8" fill="#002" fontWeight="bold" fontFamily="Arial">+ G: {gp.name} ({gp.position})</text>
                                    </g>
                                ))}
                            </g>
                        ));
                    ...
                    <g className="roll-button" onClick={() => onAction({ type: 'SKIP_EXTRA_BASE' })} cursor="pointer">
                        <rect x={420 + state.extraBaseEligible.length * 200} y="840" width="120" height="38" rx="6" fill="#334155" stroke="#64748b" strokeWidth="1.5"/>
                        <text x={480 + state.extraBaseEligible.length * 200} y="864" textAnchor="middle" fontSize="12" fill="#ccc" fontWeight="bold" fontFamily="Arial">NO THROW</text>
                    </g>
                </g>
            )}
            ...
            {!state.isOver && !isMyTurn && (
                <g>
                    <rect x="580" y="850" width="240" height="40" rx="6" fill="rgba(0,0,0,0.6)"/>
                    <text x="700" y="877" textAnchor="middle" fontSize="14" fill="#888" fontStyle="italic" fontFamily="Arial">Waiting for opponent...</text>
                </g>
            )}
            ...
            {state.isOver && (
                <g>
                    <rect x="520" y="840" width="360" height="60" rx="10" fill="rgba(0,0,0,0.85)"/>
                    <text x="700" y="880" textAnchor="middle" fontSize="28" fill="white" fontWeight="900" fontFamily="Impact,sans-serif" letterSpacing="3">
