...
const TRACKS: Track[] = [
    ...
    { file: 'sounds/music/Elderly Woman Behind the Counter in a Small Town - Remastered.mp3', title: 'Elderly Woman Behind the Counter in a Small Town', artist: 'Pearl Jam' },
    { file: 'sounds/music/Everlong.mp3', title: 'Everlong', artist: 'Foo Fighters' },
    { file: 'sounds/music/Higher.mp3', title: 'Higher', artist: 'Creed' },
    { file: 'sounds/music/Just like Heaven.mp3', title: 'Just Like Heaven', artist: 'The Cure' },
    { file: 'sounds/music/Peaches.mp3', title: 'Peaches', artist: 'The Presidents of the United States of America' },
    { file: 'sounds/music/Sugar, We\'re Goin Down.mp3', title: "Sugar, We're Goin Down", artist: 'Fall Out Boy' },
    { file: 'sounds/music/What\'s My Age Again.mp3', title: "What's My Age Again?", artist: 'blink-182' },
];
